...
const Spaceout = ({ fill = "white", size = 32 }) => {
    return(
        ...
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width={size + 10} height={size + 10} viewBox="0 0 700.000000 698.000000" preserveAspectRatio="xMidYMid meet">
        <metadata>
        </metadata>
        <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)" stroke="none">
        <path fill={fill} d="M3399 5956 c-60 -55 -126 -124 -322 -341 -124 -138 -551 -688 -588
        ...
        -57 32 -67 32 -11 0 -51 -29 -91 -64z"></path>
        <path fill={fill} d="M4216 3652 c-3 -6 -83 -51 -178 -102 -176 -95 -205 -112 -315 -184
        -60 -39 -80 -72 -50 -80 133 -38 288 -47 376 -20 75 22 139 88 168 174 25 73
        36 210 16 217 -6 2 -14 0 -17 -5z"></path>
        <path fill={fill} d="M2697 3593 c-23 -22 15 -196 57 -261 32 -51 52 -67 121 -98 50 -23
        72 -27 140 -26 77 1 210 28 254 52 43 23 25 38 -179 153 -25 14 -106 53 -180
        88 -74 35 -147 71 -162 81 -28 19 -41 22 -51 11z"></path>
        </g>
        </svg>
    )
}
