...
For the backend and blog side of things I have entrusted the good old wordpress to do the job for me, as it build in solutions have made 
everything I needed to spawn quickly the requirements needed to fullfil the project. On the front-side I have chosen the battle tested gatbsy.js 
framework that at this point always me to build any kind of UI I need in order to satisfy my clients needs.
