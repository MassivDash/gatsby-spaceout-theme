...
import Shuttle, { NextToShuttleHolder, FlexHolder } from '../components/Shuttle';
        ...
        <CSSFadeIn>
          <Section>
            ...
            <Paragraph style={{ margin: '25px 0' }}>
              ...
              wordpress, joomla, templates and themes poorly preform in the real environment.
              Solutions build for everyone, that satisfy needs of none. 
            </Paragraph>

            <Paragraph style={{ margin: '25px 0' }}>
              That how the spaceout brand was born, the idea to create awesome
              web and native applications in terms of excellent user experience,
              well crafted user interfaces and build upon the best available
              development technologies. 
            </Paragraph>

            <Paragraph style={{ margin: '25px 0' }}>
              <FlexHolder>
              <SocialLinks links={[{name: 'spaceout', url: '/about'}]} /> Łukasz Celitan
              </FlexHolder>
            ...
            <Paragraph style={{ margin: '25px 0' }}>
              Very first step in creation of whatever kind of product should always be UX (User Experience) analysis.
              User experience (UX) refers to any interaction a user has with a product or service. The goal of UX design is to create easy, efficient, relevant and all-round pleasant experiences for the user. 
              In the age of the internet and smartphones, the usability of a website (and actual technical implementation), mobile app or piece of software will largely determine its success on the market. 
            </Paragraph>
            <Paragraph style={{ margin: '25px 0' }}>
